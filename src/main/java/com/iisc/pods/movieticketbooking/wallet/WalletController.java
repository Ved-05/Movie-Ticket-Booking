...
// The WalletController class defines the REST endpoints for wallet-related
// operations.
// It uses the WalletService to handle business logic.
// The WalletResponse class represents the response payload with user ID and
// balance.
// The WalletUpdateRequest class represents the request payload for
// debiting/crediting balance.
// Error handling (e.g., insufficient balance) is handled appropriately.